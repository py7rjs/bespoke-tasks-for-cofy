...
// Returns one snapshot per insertion step.
// Pass i (1-based) shows the array after inserting element originally at index i
// into its correct position in the already-sorted prefix [0..i-1].
...
function buildRound(index: number): RoundData {
  ...
  const allPassWords = insertionSortPasses(words);
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
          Sort the fruit at the top using insertion sort. Each pass takes the next unsorted element
          and inserts it into its correct position within the already-sorted prefix. <b>Drag</b> a
          fruit into each slot to show the correct array state after every insertion, or click a
          fruit to select it and then click a slot to place it. Click the trash icon on a fruit to
